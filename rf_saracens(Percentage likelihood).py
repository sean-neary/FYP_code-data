...
Original file is located at
    https://colab.research.google.com/drive/178wLL4i0PjDjKPDYHxoHHTmEMEgxwWn6
"""
...
def simulate_matchesrf(team1, team2, n_matches=1000):
    
    match_results = []
    for i in range(n_matches):
        match_results.append(match(df2018, team1, team2, rf, random_scale=3))
...
semi1 = simulate_matchesrf('Saracens', 'Harlequins', n_matches=1000)
...
rf_Saracens_prob_win = 0.995*0.795* 100 * (0.687 ** 2)
rf_Saracens_prob_win