# -*- coding: utf-8 -*-
"""svc_Prediction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GjjGbT_PAvAKapXI6NSpKq3cWX0rJydA
"""
...
match(df2018, 'Wasps', 'Saracens', svc)

def simulate_matchessvc(team1, team2, n_matches=10000):
...
simulation_test = simulate_matchessvc('Harlequins', 'Northampton Saints', n_matches=100)
...
Game36 = simulate_matchessvc('Bristol Bears', 'Exeter Chiefs', n_matches=1)
...
fourth_desider = simulate_matchessvc('Harlequins', 'Northampton Saints', n_matches=1000)
print("Fourth place play off Winner: " + fourth_desider['overall_winner'])
...
semi2 = simulate_matchessvc('Exeter Chiefs', 'Gloucester Rugby', n_matches=1000)
